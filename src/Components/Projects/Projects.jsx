...
const projects = [
  {
    ...
    className: 'project-image-srm', // Class for the background image
    githubLink: 'https://srmistwebsiteclone.vercel.app/', // Replace with actual GitHub link
  },
  {
    title: 'URL Shortener',
    description:
    ...
    className: 'project-image-url-shortener', // Class for the background image
    githubLink: 'https://github.com/ishangoel2005/URL-Shortner', // Replace with actual GitHub link
  },
  {
    ...
    className: 'project-image-take-you-forward', // Class for the background image
    githubLink: 'https://takeyouforwardclone-zeta.vercel.app/', // Replace with actual GitHub link
  },
];
        ...
        <div className={`project ${index % 2 === 0 ? 'left' : 'right'}`} key={index}>
          ...
          >
            <h3>
              ...
              >
                {project.title} <span className="arrow">↗️</span> {/* Arrow emoji */}
              </a>
            </h3>
            <p>{project.description}</p>
          </motion.div>
          <motion.div
            className={`project-image ${project.className}`} // Add the class for the image
            initial={{ scale: 0 }}
            animate={{ scale: 1 }}
            transition={{ duration: 0.8 }}
          />
